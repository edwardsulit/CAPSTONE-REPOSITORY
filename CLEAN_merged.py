...
def process_one_source(data_source: str):
    """
    Run your full pipeline (clean → save → load) for one source file/URL.
    """
    ...
    print(f"✅ ETL load completed for {data_source}, run_id = {run_id}")
